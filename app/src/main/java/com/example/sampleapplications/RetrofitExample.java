        ...
        postDataBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nameEdt.getText().toString().isEmpty() && jobEdt.getText().toString().isEmpty()) {
                    Toast.makeText(RetrofitExample.this, "Please enter both the values", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void postData(String name, String job) {
        ...
        call.enqueue(new Callback<DataModel>() {
            ...
            public void onResponse(Call<DataModel> call, Response<DataModel> response) {
                ...
                Toast.makeText(RetrofitExample.this, "Data added to API", Toast.LENGTH_SHORT).show();
                ...
                AndroidUtils.createLogFile(RetrofitExample.this);
                AndroidUtils.logMessage("RetrofitExample.this");
            }
